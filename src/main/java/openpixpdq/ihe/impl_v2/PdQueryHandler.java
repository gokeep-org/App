 ...
 */
package openpixpdq.ihe.impl_v2;
...
import org.openhealthexchange.openpixpdq.ihe.pdq.ContinuationPointer;
...
//            }
                ...
                if (phone == null) phone = new PhoneNumber(PhoneType.WORK);
                ...
                if (phone == null) phone = new PhoneNumber(PhoneType.HOME);
                phone.setCountryCode( value );
            }
