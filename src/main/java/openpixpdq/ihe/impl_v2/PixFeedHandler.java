...
class PixFeedHandler extends BaseHandler implements Application {
	...
	throws ApplicationException, HL7Exception {
	    ...
	    auditLog(hl7Header, patient, EventActionCode.Create);
	...
	private Message processUpdate(Message msgIn) throws ApplicationException,
		...
		//Finally, Audit Log PIX Feed Success 
	    auditLog(hl7Header, patient, EventActionCode.Update);
	...
	throws ApplicationException, HL7Exception {
		...
		//Finally, Audit Log PIX Feed Success 
	    auditLog(hl7Header, patient, EventActionCode.Update);
	    auditLog(hl7Header, mrgPatient, EventActionCode.Delete);
	 ...
	 */
	private void auditLog(HL7Header hl7Header, Patient patient, EventActionCode eventActionCode) {
