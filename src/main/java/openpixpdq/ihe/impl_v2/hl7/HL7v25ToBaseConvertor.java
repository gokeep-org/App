 ...
 */
package openpixpdq.ihe.impl_v2.hl7;
...
public class HL7v25ToBaseConvertor {
    ...
    public HL7v25ToBaseConvertor(Message in, IConnectionDescription connection) {
    ...
    public PersonName getPatientAliasName() throws HL7Exception {
		...
		aName.setLastName(pid.getPatientAlias(0).getFamilyName().getSurname().getValue());
		aName.setSecondName(pid.getPatientAlias(0).getSecondAndFurtherGivenNamesOrInitialsThereof().getValue());
    ...
    public String getCitizenShip() throws HL7Exception{
    	String citizenShip = pid.getCitizenship(0).getText().getValue();
    	return citizenShip;
    ...
    public Calendar getDeathDate(){
    	return DateUtil.convertHL7DateToCalender(pid.getPatientDeathDateAndTime().getName());
    }
    ...
    public Boolean getDeathIndicator(){
    	String deathIndicator = pid.getPatientDeathIndicator().getValue();
    	if(deathIndicator != null)
    		return Boolean.valueOf(deathIndicator);
    	else
    		return false;	
    }
     ...
     */
    private AddressType _mapAddressToBase(String value) {
    	return AddressType.mapValueOf(value);
    }
    ...
    public SexType getSexType() {
    	...
    	return SexType.getByString( sex );
    }
    ...
    public List<PhoneNumber> getPhoneList() {
        ...
        try {
            ...
            if(business != null) business.setType(SharedEnums.PhoneType.WORK);
        } catch (HL7Exception e) {
