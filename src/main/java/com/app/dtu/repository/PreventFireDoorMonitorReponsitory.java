...
public interface PreventFireDoorMonitorReponsitory  extends JpaRepository<PrventFireDoorMonitorDevice, String> {
    @Modifying
    @Transactional
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE PrventFireDoorMonitorDevice device SET device.old_flag=:status where device.id = :id")
