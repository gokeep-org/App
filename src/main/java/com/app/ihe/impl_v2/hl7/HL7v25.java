...
public class HL7v25 {
   ...
   */
    public static void populateMSH(MSH msh, String type, String event, String id, IConnectionDescription connection) throws DataTypeException, IheConfigurationException, IheConfigurationException {
        // MSH-1
   ...
   */
     ...
     */
    public static PatientIdentifier extractId(GenericComposite composite, IConnectionDescription connection) throws DataTypeException {
        ...
        Identifier reconciled = AssigningAuthorityUtil.reconcileIdentifier(identifier, connection);
