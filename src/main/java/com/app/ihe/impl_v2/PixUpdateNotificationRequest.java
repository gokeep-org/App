...
import com.app.ihe.IPixUpdateNotificationRequest;
...
import com.app.ihe.impl_v2.hl7.*;
import com.app.ihe.log.MessageStore;
import com.app.ihe.util.DateUtil;
...
class PixUpdateNotificationRequest implements IPixUpdateNotificationRequest {
	...
	public void execute(){		
		...
		for(IConnectionDescription connection : actor.getPixConsumerConnections()){
			...
			List<Identifier> domainsOfInterest = connection.getAllIdentifiersByType("domain");
			...
			try{
				...
				store = actor.initMessageStore(updateMessage, false);
