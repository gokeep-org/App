...
mvn install:install-file -Dfile=axiom-api-1.2.5.jar -DgroupId=com.axiom -DartifactId=api -Dversion=2.0 -Dpackaging=jar
&&
mvn install:install-file -Dfile=axiom-dom-1.2.5.jar -DgroupId=com.axiom -DartifactId=dom -Dversion=2.0 -Dpackaging=jar
&&
mvn install:install-file -Dfile=axiom-impl-1.2.5.jar -DgroupId=com.axiom -DartifactId=impl -Dversion=2.0 -Dpackaging=jar
&&
